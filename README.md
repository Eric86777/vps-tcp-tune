...
一键安装 XanMod 内核，启用 BBR v3 拥塞控制，集成 43+ 实用工具，优化你的 VPS 服务器。

> **版本**: v4.6.0 (新增 Caddy 多域名反代)
...
本脚本包含 **43** 个核心功能，涵盖内核优化、网络加速、代理部署、系统管理等全方位需求。
...
| 编号 | 功能名称 | 说明 |
|------|---------|------|
| **40** | **Open WebUI 部署管理** | 一键部署 AI 聊天界面，Docker 容器化，支持自定义 API 配置 |
...
| 编号 | 功能名称 | 说明 |
|------|---------|------|
| **43** | **Caddy 多域名反代** | ⭐ **推荐**，一键部署 HTTPS 反向代理，自动申请 SSL 证书，支持多域名管理 |
